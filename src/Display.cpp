...
void Display::DrawLogo() {
    #if defined(DISPLAY_TYPE_SDD1306_128X64_lcdgfx)
    display->drawBitmap1(0,16,32,32,Logo_32x32);
    display->drawBitmap1(32,18,96,16,TinyTrackGPS_96x16);
    this->print(3,VERSION);
    //display->drawBitmap1(60,37,48,8,version_48x8);
    #endif
}

void Display::drawbattery(byte level){
    #if defined(DISPLAY_TYPE_SDD1306_128X64_lcdgfx)
    display->drawHLine(122,48,125);
    display->drawHLine(121,49,126);
    display->drawHLine(121,62,126);
    display->drawVLine(120,50,62);
    display->drawVLine(127,50,62);
    for(byte i=0; i<level; i++) 
        display->drawHLine(122,60-i,125);
    #endif
}
...
const PROGMEM uint8_t TinyTrackGPS_font8x16[] = {
    ...
    0x00,0x00,0x06,0x78,0x06,0x00,0x02,0x7E,0x02,0x00,0x7E,0x00,0x42,0x42,0x3C,0x00, // Code for char num 42
    0x7C,0x32,0x7C,0x00,0x0C,0x12,0x7E,0x00,0x7C,0x32,0x7C,0x00,0x42,0x42,0x3C,0x00, // Code for char num 43
    0x20, 0x00, 0x30, 0x08, 0x3E, 0x00, 0x3C, 0x12, 0x3C, 0x00, 0x38, 0x08, 0x10, 0x08, 0x38, 0x00, // - 44 'mAh'
